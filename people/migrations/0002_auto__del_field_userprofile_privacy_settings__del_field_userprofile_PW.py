...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('people_userprofile', 'privacy_settings')

        # Deleting field 'UserProfile.PW_state'
        db.delete_column('people_userprofile', 'PW_state')

        # Adding field 'UserProfile.pw_state'
        db.add_column('people_userprofile', 'pw_state',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.all_about_you'
        db.add_column('people_userprofile', 'all_about_you',
    ...
    def backwards(self, orm):
        ...
        db.add_column('people_userprofile', 'privacy_settings',
        ...
        # Deleting field 'UserProfile.all_about_you'
        db.delete_column('people_userprofile', 'all_about_you')
