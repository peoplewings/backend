...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.interested_in'
        db.alter_column('people_userprofile', 'interested_in', self.gf('django.db.models.fields.CharField')(default='', max_length=1))

    def backwards(self, orm):

        # Changing field 'UserProfile.interested_in'
        db.alter_column('people_userprofile', 'interested_in', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
