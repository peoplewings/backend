...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('people_userprofile_universities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['people.userprofile'], null=False)),
            ('university', models.ForeignKey(orm['people.university'], null=False))
        ))
        db.create_unique('people_userprofile_universities', ['userprofile_id', 'university_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('people_userprofile_universities')
