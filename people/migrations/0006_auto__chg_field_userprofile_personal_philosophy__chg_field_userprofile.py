...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('people_userprofile', 'personal_philosophy', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.what_you_like_sharing'
        db.alter_column('people_userprofile', 'what_you_like_sharing', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.pw_experience'
        db.alter_column('people_userprofile', 'pw_experience', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.quotes'
        db.alter_column('people_userprofile', 'quotes', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.pw_opinion'
        db.alter_column('people_userprofile', 'pw_opinion', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.people_inspired_you'
        db.alter_column('people_userprofile', 'people_inspired_you', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.education'
        db.alter_column('people_userprofile', 'education', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'UserProfile.occupation'
        db.alter_column('people_userprofile', 'occupation', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'UserProfile.all_about_you'
        db.alter_column('people_userprofile', 'all_about_you', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.people_you_like'
        db.alter_column('people_userprofile', 'people_you_like', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.religion'
        db.alter_column('people_userprofile', 'religion', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'UserProfile.incredible_done_seen'
        db.alter_column('people_userprofile', 'incredible_done_seen', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.political_opinion'
        db.alter_column('people_userprofile', 'political_opinion', self.gf('django.db.models.fields.CharField')(default='', max_length=20))

        # Changing field 'UserProfile.favourite_movies_series_others'
        db.alter_column('people_userprofile', 'favourite_movies_series_others', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.main_mission'
        db.alter_column('people_userprofile', 'main_mission', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'UserProfile.other_pages_you_like'
        db.alter_column('people_userprofile', 'other_pages_you_like', self.gf('django.db.models.fields.TextField')(default=''))
