...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cropped.image'
        db.delete_column('cropper_cropped', 'image')

        # Adding field 'Cropped.image_big'
        db.add_column('cropper_cropped', 'image_big',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Cropped.image_med'
        db.add_column('cropper_cropped', 'image_med',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Cropped.image_small'
        db.add_column('cropper_cropped', 'image_small',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Cropped.image_med_blur'
        db.add_column('cropper_cropped', 'image_med_blur',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Cropped.image'
        raise RuntimeError("Cannot reverse this migration. 'Cropped.image' and its values cannot be restored.")
        # Deleting field 'Cropped.image_big'
        db.delete_column('cropper_cropped', 'image_big')

        # Deleting field 'Cropped.image_med'
        db.delete_column('cropper_cropped', 'image_med')

        # Deleting field 'Cropped.image_small'
        db.delete_column('cropper_cropped', 'image_small')

        # Deleting field 'Cropped.image_med_blur'
        db.delete_column('cropper_cropped', 'image_med_blur')
    ...
    models = {
        ...
        'people.userprofile': {
            ...
            'avatar': ('django.db.models.fields.CharField', [], {'default': "'http://0.0.0.0:5000/media/blank_avatar.jpg'", 'max_length': '250'}),
            'birthday': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'blur_avatar': ('django.db.models.fields.CharField', [], {'default': "'http://0.0.0.0:5000/media/med-blank_avatar.jpg'", 'max_length': '250', 'blank': 'True'}),
            ...
            'medium_avatar': ('django.db.models.fields.CharField', [], {'default': "'http://0.0.0.0:5000/media/med-blank_avatar.jpg'", 'max_length': '250', 'blank': 'True'}),
            ...
            'thumb_avatar': ('django.db.models.fields.CharField', [], {'default': "'http://0.0.0.0:5000/media/thumb-blank_avatar.jpg'", 'max_length': '250', 'blank': 'True'}),
