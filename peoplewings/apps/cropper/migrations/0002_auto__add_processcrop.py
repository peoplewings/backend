...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProcessCrop'
        db.create_table('cropper_processcrop', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('kind', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('cropper', ['ProcessCrop'])


    def backwards(self, orm):
        # Deleting model 'ProcessCrop'
        db.delete_table('cropper_processcrop')
    ...
    models = {
        ...
        'cropper.processcrop': {
            'Meta': {'object_name': 'ProcessCrop'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'people.userprofile': {
            ...
            'medium_avatar': ('django.db.models.fields.CharField', [], {'default': "'https://peoplewings-test-media.s3.amazonaws.com/med-blank_avatar.jpg'", 'max_length': '250', 'blank': 'True'}),
            ...
            'thumb_avatar': ('django.db.models.fields.CharField', [], {'default': "'https://peoplewings-test-media.s3.amazonaws.com/thumb-blank_avatar.jpg'", 'max_length': '250', 'blank': 'True'}),
