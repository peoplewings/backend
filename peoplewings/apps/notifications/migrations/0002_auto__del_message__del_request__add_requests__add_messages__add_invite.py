...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notifications_notificationsalarm', (
            ...
            ('reference', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notification', to=orm['notifications.Notifications'])),
        ))
    ...
    models = {
        ...
        'notifications.notificationsalarm': {
            ...
            'reference': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notification'", 'to': "orm['notifications.Notifications']"})
        },
        ...
        'people.userprofile': {
            ...
            'thumb_avatar': ('django.db.models.fields.CharField', [], {'default': "'http://peoplewings-test-media.s3.amazonaws.com/thumb-blank_avatar.jpg'", 'max_length': '250'}),
