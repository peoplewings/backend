...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notifications_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications_message_receiver', to=orm['people.UserProfile'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications_message_sender', to=orm['people.UserProfile'])),
            ('timestamp', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('text', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('notifications', ['Message'])

        # Adding model 'Request'
        db.create_table('notifications_request', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications_request_receiver', to=orm['people.UserProfile'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications_request_sender', to=orm['people.UserProfile'])),
            ('timestamp', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('wing1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wing1', to=orm['wings.Wing'])),
            ('wing2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='wing2', to=orm['wings.Wing'])),
            ('text1', self.gf('django.db.models.fields.TextField')(max_length=1000, blank=True)),
            ('text2', self.gf('django.db.models.fields.TextField')(max_length=1000, blank=True)),
        ))
        db.send_create_signal('notifications', ['Request'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table('notifications_message')

        # Deleting model 'Request'
        db.delete_table('notifications_request')
    ...
    models = {
        ...
        'notifications.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notifications_message_receiver'", 'to': "orm['people.UserProfile']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notifications_message_sender'", 'to': "orm['people.UserProfile']"}),
        ...
        'notifications.request': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notifications_request_receiver'", 'to': "orm['people.UserProfile']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'notifications_request_sender'", 'to': "orm['people.UserProfile']"}),
            'text1': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'blank': 'True'}),
            'text2': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'blank': 'True'}),
            'timestamp': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'wing1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wing1'", 'to': "orm['wings.Wing']"}),
            'wing2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wing2'", 'to': "orm['wings.Wing']"})
        },
        'people.city': {
