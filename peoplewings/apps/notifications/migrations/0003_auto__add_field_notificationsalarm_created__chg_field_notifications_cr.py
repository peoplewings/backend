...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationsAlarm.created'
        db.add_column('notifications_notificationsalarm', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Notifications.created'
        db.alter_column('notifications_notifications', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'NotificationsAlarm.created'
        db.delete_column('notifications_notificationsalarm', 'created')


        # Changing field 'Notifications.created'
        db.alter_column('notifications_notifications', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
