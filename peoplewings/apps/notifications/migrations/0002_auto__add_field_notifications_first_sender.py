...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notifications.first_sender'
        db.add_column('notifications_notifications', 'first_sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications_first_sender', null=True, to=orm['people.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notifications.first_sender'
        db.delete_column('notifications_notifications', 'first_sender_id')
