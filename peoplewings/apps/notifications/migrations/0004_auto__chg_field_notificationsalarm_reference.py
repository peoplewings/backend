...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'NotificationsAlarm.reference' to match new field type.
        db.rename_column('notifications_notificationsalarm', 'reference_id', 'reference')
        # Changing field 'NotificationsAlarm.reference'
        db.alter_column('notifications_notificationsalarm', 'reference', self.gf('django.db.models.fields.CharField')(max_length=36))
        # Removing index on 'NotificationsAlarm', fields ['reference']
        db.delete_index('notifications_notificationsalarm', ['reference_id'])


    def backwards(self, orm):
        # Adding index on 'NotificationsAlarm', fields ['reference']
        db.create_index('notifications_notificationsalarm', ['reference_id'])


        # Renaming column for 'NotificationsAlarm.reference' to match new field type.
        db.rename_column('notifications_notificationsalarm', 'reference', 'reference_id')
        # Changing field 'NotificationsAlarm.reference'
        db.alter_column('notifications_notificationsalarm', 'reference_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['notifications.Notifications']))
