...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accomodation.city'
        db.add_column('wings_accomodation', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['locations.City'], on_delete=models.PROTECT),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accomodation.city'
        db.delete_column('wings_accomodation', 'city_id')
