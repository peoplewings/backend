...
class UserProfile(models.Model):
	...
	last_login_lat = models.DecimalField(max_digits=11, decimal_places=9, default=0.0)
	last_login_lon = models.DecimalField(max_digits=11, decimal_places=9, default=0.0)
