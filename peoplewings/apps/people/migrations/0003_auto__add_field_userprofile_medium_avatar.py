...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.medium_avatar'
        db.add_column('people_userprofile', 'medium_avatar',
                      self.gf('django.db.models.fields.CharField')(default='http://peoplewings-test-media.s3.amazonaws.com/med-blank_avatar.jpg', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.medium_avatar'
        db.delete_column('people_userprofile', 'medium_avatar')
