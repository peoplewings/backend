...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.name_to_show'
        db.delete_column('people_userprofile', 'name_to_show')

        # Adding field 'UserProfile.thumb_avatar'
        db.add_column('people_userprofile', 'thumb_avatar',
                      self.gf('django.db.models.fields.CharField')(default='http://peoplewings-test-media.s3.amazonaws.com/thumb-blank_avatar.jpg', max_length=250),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserProfile.name_to_show'
        db.add_column('people_userprofile', 'name_to_show',
                      self.gf('django.db.models.fields.CharField')(default='name_to_show', max_length=20),
                      keep_default=False)

        # Deleting field 'UserProfile.thumb_avatar'
        db.delete_column('people_userprofile', 'thumb_avatar')
