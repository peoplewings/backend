...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'people.userprofile': {
            ...
            'relationships': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'relationships+'", 'symmetrical': 'False', 'through': "orm['people.Relationship']", 'to': "orm['people.UserProfile']"}),
