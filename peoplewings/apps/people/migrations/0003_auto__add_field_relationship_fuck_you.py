...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Relationship.fuck_you'
        db.add_column('people_relationship', 'fuck_you',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Relationship.fuck_you'
        db.delete_column('people_relationship', 'fuck_you')
