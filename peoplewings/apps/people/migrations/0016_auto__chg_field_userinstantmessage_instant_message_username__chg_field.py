...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('people_socialnetwork', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

        # Changing field 'Language.name'
        db.alter_column('people_language', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))
        ...
        db.alter_column('people_instantmessage', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'UserInstantMessage.instant_message_username'
        db.alter_column('people_userinstantmessage', 'instant_message_username', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'SocialNetwork.name'
        db.alter_column('people_socialnetwork', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))

        # Changing field 'Language.name'
        db.alter_column('people_language', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))

        # Changing field 'UserSocialNetwork.social_network_username'
        db.alter_column('people_usersocialnetwork', 'social_network_username', self.gf('django.db.models.fields.CharField')(max_length=20))
        ...
        # Changing field 'UserProfile.company'
        db.alter_column('people_userprofile', 'company', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'UserProfile.phone'
        db.alter_column('people_userprofile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'InstantMessage.name'
        db.alter_column('people_instantmessage', 'name', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))
