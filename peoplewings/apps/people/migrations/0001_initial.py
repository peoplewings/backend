...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('people_userprofile', (
            ...
            ('thumb_avatar', self.gf('django.db.models.fields.CharField')(default='http://peoplewings-test-media.s3.amazonaws.com/med-blank_avatar.jpg', max_length=250, blank=True)),
            ('blur_avatar', self.gf('django.db.models.fields.CharField')(default='http://peoplewings-test-media.s3.amazonaws.com/med-blank_avatar.jpg', max_length=250, blank=True)),
            ...
            ('last_login', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ll+', null=True, to=orm['locations.City'])),
