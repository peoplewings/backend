...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserLanguage.level'
        db.alter_column('people_userlanguage', 'level', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'UserLanguage.level'
        db.alter_column('people_userlanguage', 'level', self.gf('django.db.models.fields.CharField')(max_length=1))
