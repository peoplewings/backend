...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserLanguage', fields ['language', 'user_profile']
        db.create_unique('people_userlanguage', ['language_id', 'user_profile_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserLanguage', fields ['language', 'user_profile']
        db.delete_unique('people_userlanguage', ['language_id', 'user_profile_id'])
