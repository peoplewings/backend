...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.show_birthday'
        db.alter_column('people_userprofile', 'show_birthday', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'UserProfile.show_birthday'
        db.alter_column('people_userprofile', 'show_birthday', self.gf('django.db.models.fields.CharField')(max_length=1))
