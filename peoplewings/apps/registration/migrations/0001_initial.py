...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('registration_registrationprofile', (
            ...
            ('key_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal('registration', ['RegistrationProfile'])

        # Adding model 'TermsAndConditions'
        db.create_table('registration_termsandconditions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('registration_date', self.gf('django.db.models.fields.BigIntegerField')()),
            ('deletion_date', self.gf('django.db.models.fields.BigIntegerField')(null=True)),
            ('has_accepted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('registration', ['TermsAndConditions'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('registration_termsandconditions')
    ...
    models = {
        ...
        'registration.registrationprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'unique': 'True'})
        },
        'registration.termsandconditions': {
            'Meta': {'object_name': 'TermsAndConditions'},
            'deletion_date': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '75'}),
            'has_accepted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'registration_date': ('django.db.models.fields.BigIntegerField', [], {}),
