...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApiToken.last'
        db.alter_column('customauth_apitoken', 'last', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'ApiToken.last'
        db.alter_column('customauth_apitoken', 'last', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
