...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('customauth_apitoken', (
            ...
            ('last_js', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
        ))
        db.send_create_signal('customauth', ['ApiToken'])


    def backwards(self, orm):
        # Deleting model 'ApiToken'
        db.delete_table('customauth_apitoken')
    ...
    models = {
        ...
        'customauth.apitoken': {
            ...
            'last_js': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
